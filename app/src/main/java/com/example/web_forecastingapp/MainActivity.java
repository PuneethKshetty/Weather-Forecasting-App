package com.example.web_forecastingapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    private class weatherTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String args[]) {
            String response = HttpRequest.excuteGet("https://api.openweathermap.org/data/2.5/weatherq="+CITY1+"&units=metric&appid=dae220eb14d47837badc80078ef8b3c1");
            return response;
        }
        @Override
